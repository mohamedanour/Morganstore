					...
					for ( let i = 0; i < posts.length; i++ ) {
						...
						postElements.push(
							el( "div",
								...
								el( "a",
									{
										key: 		'gbt_18_th_editor_posts_grid_item_link_' + i,
										className: 	'gbt_18_th_editor_posts_grid_item_link'
									},
									el( "span",
										{
											key: 		'gbt_18_th_editor_posts_grid_img_container_' + i,
											className: 	'gbt_18_th_editor_posts_grid_img_container'
										},
										el( "span",
											{
												key: 'gbt_18_th_editor_posts_grid_img_overlay_' + i,
												className: 'gbt_18_th_editor_posts_grid_img_overlay'
											}
										),
										el( "span",
											{
												key: 		'gbt_18_th_editor_posts_grid_img_' + i,
									...
									el( "span",
										{
											key: 		'gbt_18_th_editor_posts_grid_title_' + i,
					...
					for ( let i = 0; i < catArr.length; i++ ) {
						...
						categoryElements.push(
							el(
								'li',
								{
									key: 'posts-grid-categories_' + i,
									className: 'level-' + catArr[i].level,
								},
								el(
								'label',
									{
										key: 'posts-grid-categories-label_' + i,
